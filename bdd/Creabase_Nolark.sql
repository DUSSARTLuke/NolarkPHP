...
DROP DATABASE IF EXISTS NOLARKPHP;
CREATE DATABASE IF NOT EXISTS NOLARKPHP;
USE NOLARKPHP;
...
(
    ...
    CONSTRAINT fk_membre FOREIGN KEY (idmembre) REFERENCES membres (id),
    CONSTRAINT FK_MEMBRE_COMMANDE_IDMEMBRE FOREIGN KEY (IDARTICLE)
