 ...
 <section id="inscrit">
        ...
        <form action="trait-inscription.php" method="post" name="Inscription">
            <fieldset><legend>Identifiants</legend>
                <div><label for="pseudo" class="inscrit">Pseudo : (compris entre 3 et 32 caractères)</label> <input type="text" name="pseudo" id="pseudo" size="30" /></div>  
                <div><label for="mdp" class="inscrit">Mot de passe : (compris entre 4 et 50 caractères)</label> <input type="password" name="mdp" id="mdp" size="30" /></div>
                <div><label for="mdp_verif" class="inscrit">Mot de passe (vérification) :</label> <input type="password" name="mdp_verif" id="mdp_verif" size="30" /></div>
                <div><label for="mail" class="inscrit">Mail :</label> <input type="text" name="mail" id="mail" size="30" /></div>
                <div><label for="mail_verif" class="inscrit">Mail (vérification) :</label> <input type="text" name="mail_verif" id="mail_verif" size="30" /></div>
                <div><label for="date_naissance" class="inscrit">Date de naissance : (format JJ/MM/AAAA)</label> <input type="text" name="date_naissance" id="date_naissance" size="30" /></div>
